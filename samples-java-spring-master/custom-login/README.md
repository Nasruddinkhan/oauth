...
```bash
cd custom-login
mvn -Dokta.oauth2.issuer=https://dev-67676563.okta.com/oauth2/default \
    -Dokta.oauth2.clientId=0oa2lxpv4x0WYXdvt5d7 \
    -Dokta.oauth2.clientSecret=5AF4Ay0yKGPkIn4VQys6EitAMbWNz3dGD0Hw9G-e
```
...
```bash
export OKTA_OAUTH2_ISSUER=https://dev-67676563.okta.com/oauth2/default
export OKTA_OAUTH2_CLIENT_ID=0oa2lxpv4x0WYXdvt5d7
export OKTA_OAUTH2_CLIENT_SECRET=5AF4Ay0yKGPkIn4VQys6EitAMbWNz3dGD0Hw9G-e
```
